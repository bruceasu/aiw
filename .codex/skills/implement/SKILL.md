...
primary workspace; use `aiw wt` only for explicitly authorized isolation.
...
Perform one static review and report Task completion separately from Git
delivery. Do not automatically commit, merge, push, clean up, or archive.
