#!/usr/bin/env python3
"""Validate an ENG_REVIEW.md (or design.md) against the eng-review-finance
Output Format.
...
Usage:
  python scripts/validate_eng_review.py <path-to-md-file>
  python scripts/validate_eng_review.py <path-to-md-file> --strict
  python scripts/validate_eng_review.py <path-to-md-file> --json
...
def main(argv: Optional[Iterable[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate an ENG_REVIEW.md against eng-review-finance."
    )
    ...
    if args.json:
        ...
        if ok:
            print("Engineering Review validation passed.")
        else:
            print("Engineering Review validation failed:")
            for e in errors:
                print(f"- {e}")
