...
Arguments:
- subdir — Path to the subdirectory to promote to root. This directory must exist in the current HEAD.
- --force — By default, the command will ask for confirmation before proceeding. Use --force to skip confirmation.
