...
- **WHEN** no explicit interpreter is configured and a supported Python executable exists in the `python` directory beside the AIW executable
...
- **THEN** the plugin exits before sending a request and reports the missing credential
...
<!-- archived spec: aiw-git-python-compatibility -->
...
<!-- archived spec: python-interpreter-configuration -->
