...
- **WHEN** the current workspace, workspace kind, or branch conflicts with the resolved task
  metadata
...
- **THEN** the Skill leaves delivery pending and preserves the branch and worktree
