# skill-work-management Specification

## Purpose

Define OpenSpec-canonical local work management and optional external Issue
projection behavior for engineering Skills.
