...
- [x] 5.1 Add CLI-level tests for new Task creation, existing Task reuse, partial repair, and conflict refusal.
- [x] 5.2 Add tests for handoff precedence, copying, hashes, pending/consumed states, and retry cleanup.
- [x] 5.3 Add tests for invalid-name confirmation, running Session refusal, takeover, and lineage diagnostics.
...
- [x] Existing Task reuse and fresh Thread startup verified at the command seam.
- [x] Missing Task creation from handoff verified, including copied artifact and RUNNING status.
- [x] Partial metadata repair and missing Session creation verified.
- [x] Explicit handoff precedence, unrelated Session conflict, and running Session refusal verified.
- [x] Invalid identity refusal, pending/consumed audit persistence, and failed creation cleanup verified.
