...
META = {
	...
	'usage': 'aiw git get-file-from <commit|branch> <path>',
	'args': [],
	'examples': ['aiw git get-file-from origin/main path/to/file']
}
...
def main(argv):
	...
	if any(f in argv for f in help_flags):
		...
		return 0
	if len(argv) < 2:
		print('usage: aiw git get-file-from <commit|branch> <path>', file=sys.stderr)
		return 2
