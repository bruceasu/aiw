...
META = {
	...
	'usage': 'aiw git rm-keep <path>',
	'args': [],
	'examples': ['aiw git rm-keep path/to/file']
}
...
def main(argv):
	...
	if any(f in argv for f in help_flags):
		...
		return 0
	if not argv:
		print('usage: aiw git rm-keep <path>', file=sys.stderr)
		return 2
