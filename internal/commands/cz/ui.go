...
type LineUI struct {
	...
	PromptMultilineEditorFn func(string, Config, string) (string, error)
}

func (ui LineUI) DraftFromWizard(cfg Config) (Draft, error) {
	d := Draft{}
...
func (ui LineUI) DraftFromLLM(cfg Config) (Draft, error) {
	return Draft{}, errors.New("DraftFromLLM not implemented for LineUI")
}
...
func PromptMultilineWithEditor(prompt string, cfg Config, current string) (string, error) {
...
func EditInExternalEditor(cfg Config, initial string) (string, error) {
...
func BuildSubjectPrompt(cfg Config, current string) string {
...
func PromptFooterPrefix(cfg Config, promptFn func(string) string) string {
...
func NewDefaultUI(interactive bool, promptLineFn func(string) string, promptMultilineFn func(string, Config, string) (string, error), teaUIFactory func() UI) UI {
	if !interactive {
