...
Usage:
  python scripts/validate_office_hours.py <path-to-md-file>
  python scripts/validate_office_hours.py <path-to-md-file> --strict
  python scripts/validate_office_hours.py <path-to-md-file> --json
...
def main(argv: Optional[Iterable[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate a Problem Brief against office-hours-finance."
    )
    ...
    if args.json:
        ...
        if ok:
            print("Problem Brief validation passed.")
        else:
            print("Problem Brief validation failed:")
            for e in errors:
                print(f"- {e}")
