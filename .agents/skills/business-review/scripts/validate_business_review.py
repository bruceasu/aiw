...
Usage:
  python scripts/validate_business_review.py <path-to-md-file>
  python scripts/validate_business_review.py <path-to-md-file> --strict
  python scripts/validate_business_review.py <path-to-md-file> --json
...
def main(argv: Optional[Iterable[str]] = None) -> int:
    parser = argparse.ArgumentParser(
        description="Validate a BUSINESS_REVIEW.md against business-review."
    )
    ...
    if args.json:
        ...
        if ok:
            print("Business Review validation passed.")
        else:
            print("Business Review validation failed:")
            for e in errors:
                print(f"- {e}")
